...
class AppColors {
  ...
  static const Color darkSecondaryVariant = Color(0xFFFFCC02);
  ...
  // 주식 관련 컬러
  static const Color stockUp = Color(0xFFE53E3E);    // 상승 빨간색
  static const Color stockDown = Color(0xFF3182CE);  // 하락 파란색
  static const Color stockFlat = Color(0xFF718096);  // 보합 회색
